package com.example.adammb.myintentapp;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPindahDataActivity=(Button) findViewById(R.id.btn_move_activity_object);
        btnPindahDataActivity.setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_pindah_dengan_data:
                ...
                moveDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "CodeLabs Boy");
                moveDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 31);
                startActivity(moveDataIntent);
                break;

            case R.id.btn_dial_number:
                String phoneNumber = "081318920636";
            ...
            case R.id.btn_move_activity_object:
                ...
                mPerson.setName("Adam Mukharil Bachtiar");
                mPerson.setAge(31);
                mPerson.setEmail("adam@email.unikom.ac.id");
